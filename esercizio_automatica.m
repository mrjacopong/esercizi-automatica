...
fprintf('\n\nPER FAR PARTIRE IL PROGRAMMA PREMI UN TASTO QUALSIASI\n');
...
if ((div3 || div4) == 0) || ragg==1          
      while 1
         ...
         fprintf('\n3-Modifica A33');
         fprintf('\n4-Modifica A44');
         fprintf('\n\n-per uscire da questa fuznione premi invio\n');
         sel=input('\nsel=','s');
         switch(sel)
            case '1'
...
%%%parte finale, si guida l'utente alla lettura dei risultati
fprintf('\nIl programma è concluso, nella comand window sono usciti automaticamente');
fprintf('\ni risultati più importanti, scorri in alto e cerca quello che più ti interessa');
fprintf('\n\nNella workspace come puoi notare ci sono tutti gli altri valori');
fprintf('\nnon sono in ordine, ma i nomi sono tutti giusti');
fprintf('\npuoi richiamarli nella workspace per vederli');
fprintf('\n\nBuono studio!!');

%%faccio un po' di pulizia per rendere più leggibili i risulati nella workspace

clear q1 q2 q3 q4 i j k s alfa I preintersezione sizepreint autov h sel div1;
clear div2 div3 div4;
